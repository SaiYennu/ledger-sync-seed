...
class AmountsTest {
    ...
    void readsWholeRupeeAmountWithoutDecimals() {
        // Incident INC-2026-09-11 reproduction: ₹5 spent on water can with Avl Bal Rs.92,213.10
    ...
    @Test
    void readsWholeRupeesWithThousandsSeparatorAndNoDecimals() {
